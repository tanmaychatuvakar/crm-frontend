...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={css(
      "flex h-[2.865rem] w-full items-center justify-between rounded-sm border bg-white px-5 py-[1.3rem] font-light border-black border-opacity-60 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={css("py-1.5 pl-8 pr-2 text-sm font-semibold", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={css("-mx-1 my-1 h-px bg-gray-100", className)}
    {...props}
  />
));
